...
using Entitas.InstallerGenerator2.Editor.CodeGenerators;
using Entitas.InstallerGenerator2.Editor.Extensions;
using Entitas.InstallerGenerator2.Editor.Models;
using Entitas.InstallerGenerator2.Runtime.Attributes;
using UnityEditor;
using UnityEngine;

namespace Entitas.InstallerGenerator2.Editor
{
    public class EcsInstallerGenerator
    {
        private const string SaveKeyPath = "Entitas.InstallerGenerator2.Path";
